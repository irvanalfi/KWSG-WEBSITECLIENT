    ...
    <div class="main-menu">
        ...
        <div class="menu-container">
            ...
            <div class="text-center">
                <a href="<?= site_url('Auth_c/logout') ?>" class="btn btn-outline-danger text-white rounded my-3 mx-auto">Sign out</a>
            </div>
        </div>
    </div>
        ...
        <header class="header shadow">
            <div class="row">
                ...
                <div class="text-left col align-self-center">
                    <a class="navbar-brand pl-5" href="<?= site_url('Profile_c') ?>">
    ...
    <div class="footer">
        <div class="row no-gutters justify-content-center">
            <div class="col-auto pl-2">
                <a href="<?= site_url('home_c'); ?>" class="<?= $this->uri->segment(1) == 'home_c' ? 'active' : ''; ?>">
            ...
            <div class="col-auto pl-3">
                <a href="<?= site_url('aapp_c'); ?>" class="<?= $this->uri->segment(1) == 'aapps_c' ? 'active' : ''; ?>">
                    <i class="material-icons">perm_device_information</i>
                    <p>About Apss</p>
                </a>
            </div>
            <div class="col-auto pl-3">
                <a href="<?= site_url('profile_c'); ?>" class="<?= $this->uri->segment(1) == 'profile_c' ? 'active' : ''; ?>">
